...

  {
    ...
    config = function()
      ...
      require("which-key").add({
        ...
        { "<Leader>xxx", "<CMD>Trouble diagnostics toggle filter.buf=0 filter.severity=vim.diagnostic.severity.ERROR<CR>", desc = "Toggle document diagnostics" },
        { "<Leader>xxw", "<CMD>Trouble diagnostics toggle filter.buf=0 filter.severity=vim.diagnostic.severity.WARN<CR>", desc = "Toggle document diagnostics" },
